...
;
; 256 octets et non 1 Ko depuis le menu MAP (2026-09-04). ProDOS lit par blocs
; de 512 octets et les met en cache dans SON tampon ($0800) : reduire le
; notre ne change pas le nombre de blocs lus, seulement le nombre d'appels a
; fread -- 32 au lieu de 8 pour une image de 8 Ko, quelques centaines de
; microsecondes en regard des dizaines de millisecondes du disque. Les 768
; octets rendus ont fait place en RAM basse a l'etat de l'application, a la
; table de rabattement page -> clairiere, a la barre de titre et aux lignes de
; corps, qui ont quitte la fenetre principale d'autant.
        .segment "LOWBSS"
